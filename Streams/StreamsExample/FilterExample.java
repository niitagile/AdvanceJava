...
public class FilterExample {  
    public static void main(String[] args) {  
     ...
     /* float totalPrice2 = productsList.stream()  
                ...
                .reduce(2.0f,Float::sum);   // accumulating price, by referring method of Float class  
        System.out.println(totalPrice2);*/ //203000.0
      
      /* Optional<Product> productA = productsList.stream()  
                .reduce((product1, product2)->   
                product1.price > product2.price ? product1: product2);  
  
        	productA.ifPresent(System.out.println(product.get().price));*/
